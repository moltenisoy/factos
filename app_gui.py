...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.categories = [
            ("Red y Conectividad",
             "Optimiza TCP/IP, DNS, firewall y configuraciones de red para\nmejorar velocidad y reducir latencia de conexión",
             "backup_opt_network.json",
             opt_network.apply_network),
            ("Gráficos y Rendimiento Visual",
             "Mejora GPU, pantalla, DWM y efectos visuales para\nmaximizar FPS y respuesta en juegos y aplicaciones gráficas",
             "backup_opt_graphics.json",
             opt_graphics.apply_all),
            ("Energía y CPU",
             "Configura gestión de energía y CPU para máximo rendimiento,\ndesactiva ahorro de energía y optimiza procesador",
             "backup_opt_power.json",
             opt_power.apply_power),
            ("Privacidad y Seguridad",
             "Desactiva telemetría, diagnósticos y seguimiento de Windows,\nprotege tu privacidad deshabilitando recopilación de datos",
             "backup_opt_privacy.json",
             opt_privacy.apply_privacy),
            ("Servicios de Windows",
             "Deshabilita servicios innecesarios de Windows para\nliberar recursos del sistema y mejorar velocidad general",
             "backup_opt_services.json",
             opt_services.apply_services),
            ("Almacenamiento y Disco",
             "Optimiza SSD, disco, indexación y compresión para\nmejorar tiempos de lectura/escritura y vida útil del disco",
             "backup_opt_storage.json",
             opt_storage.apply_storage),
        ]
        ...
        if apply_func:
            try:
                ...
                worker.finished.connect(
                    lambda _success: self.on_optimization_finished(backup_file))
