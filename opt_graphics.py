...
def apply_all():
    ...
    set_reg(
        ...
        0,
        reg.REG_DWORD)
    set_reg("HKCU\\Software\\Microsoft\\Windows\\DWM",
            "EnableAnimations", 0, reg.REG_DWORD)
    set_reg("HKCU\\Software\\Microsoft\\Windows\\DWM",
            "EnableTransparency", 0, reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\Windows\\Dwm",
            "OverlayTestMode", 5, reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\Windows\\Dwm",
            "ForceDoubleBuffer", 1, reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\Windows\\Dwm",
            "MaxQueuedBuffers", 2, reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\Windows\\Dwm",
            "EnablePerProcessSystemScheduling", 1, reg.REG_DWORD)
    set_reg(
    ...
    set_reg(
        ...
        reg.REG_SZ)
    set_reg(
        "HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Multimedia\\SystemProfile\\Tasks\\Playback",
        "Scheduling Category",
        "High",
        reg.REG_SZ)
    set_reg(
        "HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Multimedia\\SystemProfile\\Tasks\\Capture",
        "Scheduling Category",
        "High",
        reg.REG_SZ)
    set_reg(
        "HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Multimedia\\SystemProfile\\Tasks\\Distribution",
        "Scheduling Category",
        "High",
        reg.REG_SZ)
    set_reg(
    ...
    set_reg(
        ...
        1,
        reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "RMDisablePostL2Compression", 1, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "RmDisableRegistryCaching", 1, reg.REG_DWORD)
    set_reg(
        ...
        reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "PlatformSupportMiracast", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "RmGpsPsEnablePerCpuCoreDpc", 1, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "MonitorLatencyTolerance", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "MonitorRefreshLatencyTolerance", 0, reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
        "EnablePreemption",
        0,
    ...
    set_reg(
        ...
        reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "EnableMidGfxPreemptionVGPU", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "EnableMidBufferPreemptionForHighTdrTimeout", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "EnableAsyncMidBufferPreemption", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "EnableSCGMidBufferPreemption", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "PerfAnalyzeMidBufferPreemption", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "EnableMidGfxPreemption", 0, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "EnableMidBufferPreemption", 0, reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
        "EnableCEPreemption",
        0,
    ...
    set_reg(
        ...
        reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "ForceThreadedRendering", 1, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "DisableMultithreading", 1, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "DisableHWAcceleration", 0, reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
        "GraphicsPreemption",
        2,
        reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "DisableCudaContextPreemption", 1, reg.REG_DWORD)
    set_reg("HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers",
            "DisablePreemptionOnS3S4", 1, reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers\\Power",
        "RMDisablePostL2Compression",
        1,
        reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers\\Power",
        "RmDisableRegistryCaching",
        1,
        reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers\\Power",
    ...
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers\\Power",
        "EnableSCGMidBufferPreemption",
        0,
        reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers\\Power",
        "PerfAnalyzeMidBufferPreemption",
        0,
        reg.REG_DWORD)
    set_reg(
        "HKLM\\SYSTEM\\CurrentControlSet\\Control\\GraphicsDrivers\\Power",
    ...
    set_reg(
        ...
        60,
        reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\DirectDraw",
            "DisableAGPSupport", 0, reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\DirectDraw",
            "UseNonLocalVidMem", 1, reg.REG_DWORD)
    set_reg("HKLM\\SOFTWARE\\Microsoft\\Direct3D",
            "UseNonLocalVidMem", 1, reg.REG_DWORD)
    run_cmd(
